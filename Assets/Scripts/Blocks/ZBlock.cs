...
namespace Assets.Scripts.Blocks
{
    public class ZBlock : Block
    {
        private Vector3[][][] tiles = new Vector3[][][]
        {
            new Vector3[][]
            {
                    new Vector3[]{new(1,0,0),new(1,0,1),new(1,1,1),new(1,1,2)},
                    new Vector3[]{new(1,0,2),new(1,1,1),new(1,1,2),new(1,2,1)},
                    new Vector3[]{new(1,1,0),new(1,1,1),new(1,2,1),new(1,2,2)},
                    new Vector3[]{new(1,0,1),new(1,1,0),new(1,1,1),new(1,2,0)}
            },
            new Vector3[][]
            {
            ...
            new Vector3[][]
            {
                    new Vector3[]{new(0,0,1),new(0,1,1),new(1,1,1),new(1,2,1)},
                    new Vector3[]{new(0,2,1),new(1,1,1),new(1,2,1),new(2,1,1)},
                    new Vector3[]{new(1,0,1),new(1,1,1),new(2,1,1),new(2,2,1)},
